...
- **Deploy after implementation:** After completing a phase, feature, or significant task, push to origin (`git push origin <branch>`) so Vercel and Railway auto-deploy. Never leave completed work unpushed.
